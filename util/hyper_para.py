...
class HyperParameters():
    def parse(self, unknown_arg_ok=False):
        ...
        parser.add_argument('-b', '--batch_size', help='Batch size', default=8, type=int)  # 12
        parser.add_argument('--lr', help='Initial learning rate', default=2.25e-4, type=float)
        parser.add_argument('--steps', help='Iteration at which learning rate is decayed by gamma',
                            default=[22500, 37500], type=int, nargs='*')
        ...
        parser.add_argument('--load', help='Path to pretrained model if available', default='./pretrained_models/model',
                            type=str)
